    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: THEME.white, fontSize: '28px', fontWeight: '800', margin: '0 0 8px 0', letterSpacing: '-0.5px' }}>Create an Account</h1>
          <p style={{ color: THEME.secondary, fontSize: '15px', margin: 0 }}>Join CourseLit and start learning today.</p>
        </div>

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            <label style={{ display: 'block', color: THEME.secondary, fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>FULL NAME</label>
            <input
              type="text"
          ...
          <div>
            <label style={{ display: 'block', color: THEME.secondary, fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>PASSWORD</label>
            <input
              type="password"
              placeholder="••••••••"
              value={password}
